...
namespace Mammut.TestHarness.Repository
{
	...
	{        
		public void Export_Sales_SalesReason()
		{
            ...
            //if(client.Schema.Exists("AdventureWorks2008R2:Sales:SalesReason"))
			//{
			//	return;
			//}
            ...
            client.Schema.CreateAll("AdventureWorks2008R2:Sales:SalesReason");
					...
					using (SqlCommand command = new SqlCommand("SELECT * FROM Sales.SalesReason", connection))
					{
						...
						using (SqlDataReader dataReader = command.ExecuteReader(System.Data.CommandBehavior.CloseConnection))
						{
							...
							while (dataReader.Read() && rowCount < 1000 /*easy replace*/)
							{
								...
								{
									Console.WriteLine("AdventureWorks2008R2:Sales:SalesReason: {0}", rowCount);
								}
								...
								try
								{
									client.Document.Create("AdventureWorks2008R2:Sales:SalesReason", new Models.Sales_SalesReason
									{
