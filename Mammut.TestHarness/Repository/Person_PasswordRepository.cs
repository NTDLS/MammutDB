...
namespace Mammut.TestHarness.Repository
{
	...
	{        
		public void Export_Person_Password()
		{
            ...
            //if(client.Schema.Exists("AdventureWorks2008R2:Person:Password"))
			//{
			//	return;
			//}
            ...
            client.Schema.CreateAll("AdventureWorks2008R2:Person:Password");
					...
					using (SqlCommand command = new SqlCommand("SELECT * FROM Person.Password", connection))
					{
						...
						using (SqlDataReader dataReader = command.ExecuteReader(System.Data.CommandBehavior.CloseConnection))
						{
							...
							while (dataReader.Read() && rowCount < 1000 /*easy replace*/)
							{
								...
								{
									Console.WriteLine("AdventureWorks2008R2:Person:Password: {0}", rowCount);
								}
								...
								try
								{
									client.Document.Create("AdventureWorks2008R2:Person:Password", new Models.Person_Password
									{
