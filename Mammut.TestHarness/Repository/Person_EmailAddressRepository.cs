...
namespace Mammut.TestHarness.Repository
{
	...
	{        
		public void Export_Person_EmailAddress()
		{
            ...
            //if(client.Schema.Exists("AdventureWorks2008R2:Person:EmailAddress"))
			//{
			//	return;
			//}
            ...
            client.Schema.CreateAll("AdventureWorks2008R2:Person:EmailAddress");
					...
					using (SqlCommand command = new SqlCommand("SELECT * FROM Person.EmailAddress", connection))
					{
						...
						using (SqlDataReader dataReader = command.ExecuteReader(System.Data.CommandBehavior.CloseConnection))
						{
							...
							while (dataReader.Read() && rowCount < 1000 /*easy replace*/)
							{
								...
								{
									Console.WriteLine("AdventureWorks2008R2:Person:EmailAddress: {0}", rowCount);
								}
								...
								try
								{
									client.Document.Create("AdventureWorks2008R2:Person:EmailAddress", new Models.Person_EmailAddress
									{
