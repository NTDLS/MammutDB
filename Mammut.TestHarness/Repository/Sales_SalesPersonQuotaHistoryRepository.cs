...
namespace Mammut.TestHarness.Repository
{
	...
	{        
		public void Export_Sales_SalesPersonQuotaHistory()
		{
            ...
            //if(client.Schema.Exists("AdventureWorks2008R2:Sales:SalesPersonQuotaHistory"))
			//{
			//	return;
			//}
            ...
            client.Schema.CreateAll("AdventureWorks2008R2:Sales:SalesPersonQuotaHistory");
					...
					using (SqlCommand command = new SqlCommand("SELECT * FROM Sales.SalesPersonQuotaHistory", connection))
					{
						...
						using (SqlDataReader dataReader = command.ExecuteReader(System.Data.CommandBehavior.CloseConnection))
						{
							...
							while (dataReader.Read() && rowCount < 1000 /*easy replace*/)
							{
								...
								{
									Console.WriteLine("AdventureWorks2008R2:Sales:SalesPersonQuotaHistory: {0}", rowCount);
								}
								...
								try
								{
									client.Document.Create("AdventureWorks2008R2:Sales:SalesPersonQuotaHistory", new Models.Sales_SalesPersonQuotaHistory
									{
