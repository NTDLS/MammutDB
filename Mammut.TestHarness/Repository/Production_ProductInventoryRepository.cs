...
namespace Mammut.TestHarness.Repository
{
	...
	{        
		public void Export_Production_ProductInventory()
		{
            ...
            //if(client.Schema.Exists("AdventureWorks2008R2:Production:ProductInventory"))
			//{
			//	return;
			//}
            ...
            client.Schema.CreateAll("AdventureWorks2008R2:Production:ProductInventory");
					...
					using (SqlCommand command = new SqlCommand("SELECT * FROM Production.ProductInventory", connection))
					{
						...
						using (SqlDataReader dataReader = command.ExecuteReader(System.Data.CommandBehavior.CloseConnection))
						{
							...
							while (dataReader.Read() && rowCount < 1000 /*easy replace*/)
							{
								...
								{
									Console.WriteLine("AdventureWorks2008R2:Production:ProductInventory: {0}", rowCount);
								}
								...
								try
								{
									client.Document.Create("AdventureWorks2008R2:Production:ProductInventory", new Models.Production_ProductInventory
									{
