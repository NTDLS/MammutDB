...
namespace Mammut.TestHarness.Repository
{
	...
	{        
		public void Export_Production_TransactionHistoryArchive()
		{
            ...
            //if(client.Schema.Exists("AdventureWorks2008R2:Production:TransactionHistoryArchive"))
			//{
			//	return;
			//}
            ...
            client.Schema.CreateAll("AdventureWorks2008R2:Production:TransactionHistoryArchive");
					...
					using (SqlCommand command = new SqlCommand("SELECT * FROM Production.TransactionHistoryArchive", connection))
					{
						...
						using (SqlDataReader dataReader = command.ExecuteReader(System.Data.CommandBehavior.CloseConnection))
						{
							...
							while (dataReader.Read() && rowCount < 1000 /*easy replace*/)
							{
								...
								{
									Console.WriteLine("AdventureWorks2008R2:Production:TransactionHistoryArchive: {0}", rowCount);
								}
								...
								try
								{
									client.Document.Create("AdventureWorks2008R2:Production:TransactionHistoryArchive", new Models.Production_TransactionHistoryArchive
									{
