...
namespace Mammut.TestHarness.Repository
{
	...
	{        
		public void Export_Sales_Currency()
		{
            ...
            //if(client.Schema.Exists("AdventureWorks2008R2:Sales:Currency"))
			//{
			//	return;
			//}
            ...
            client.Schema.CreateAll("AdventureWorks2008R2:Sales:Currency");
					...
					using (SqlCommand command = new SqlCommand("SELECT * FROM Sales.Currency", connection))
					{
						...
						using (SqlDataReader dataReader = command.ExecuteReader(System.Data.CommandBehavior.CloseConnection))
						{
							...
							while (dataReader.Read() && rowCount < 1000 /*easy replace*/)
							{
								...
								{
									Console.WriteLine("AdventureWorks2008R2:Sales:Currency: {0}", rowCount);
								}
								...
								try
								{
									client.Document.Create("AdventureWorks2008R2:Sales:Currency", new Models.Sales_Currency
									{
