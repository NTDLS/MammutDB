...
namespace Mammut.TestHarness.Repository
{
	...
	{        
		public void Export_Person_CountryRegion()
		{
            ...
            //if(client.Schema.Exists("AdventureWorks2008R2:Person:CountryRegion"))
			//{
			//	return;
			//}
            ...
            client.Schema.CreateAll("AdventureWorks2008R2:Person:CountryRegion");
					...
					using (SqlCommand command = new SqlCommand("SELECT * FROM Person.CountryRegion", connection))
					{
						...
						using (SqlDataReader dataReader = command.ExecuteReader(System.Data.CommandBehavior.CloseConnection))
						{
							...
							while (dataReader.Read() && rowCount < 1000 /*easy replace*/)
							{
								...
								{
									Console.WriteLine("AdventureWorks2008R2:Person:CountryRegion: {0}", rowCount);
								}
								...
								try
								{
									client.Document.Create("AdventureWorks2008R2:Person:CountryRegion", new Models.Person_CountryRegion
									{
