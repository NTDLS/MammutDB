...
namespace Mamoth.TestHarness.Repository
{
	...
	{        
		public void Export_Sales_CountryRegionCurrency()
		{
            ...
            //if(client.Schema.Exists("AdventureWorks2008R2:Sales:CountryRegionCurrency"))
			//{
			//	return;
			//}
            ...
            client.Schema.CreateAll("AdventureWorks2008R2:Sales:CountryRegionCurrency");
					...
					using (SqlCommand command = new SqlCommand("SELECT * FROM Sales.CountryRegionCurrency", connection))
					{
						...
						using (SqlDataReader dataReader = command.ExecuteReader(System.Data.CommandBehavior.CloseConnection))
						{
							...
							while (dataReader.Read() && rowCount < 1000 /*easy replace*/)
							{
								...
								{
									Console.WriteLine("AdventureWorks2008R2:Sales:CountryRegionCurrency: {0}", rowCount);
								}
								...
								try
								{
									client.Document.Create("AdventureWorks2008R2:Sales:CountryRegionCurrency", new Models.Sales_CountryRegionCurrency
									{
