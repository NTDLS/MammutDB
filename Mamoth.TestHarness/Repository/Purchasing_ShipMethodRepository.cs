...
namespace Mamoth.TestHarness.Repository
{
	...
	{        
		public void Export_Purchasing_ShipMethod()
		{
            ...
            //if(client.Schema.Exists("AdventureWorks2008R2:Purchasing:ShipMethod"))
			//{
			//	return;
			//}
            ...
            client.Schema.CreateAll("AdventureWorks2008R2:Purchasing:ShipMethod");
					...
					using (SqlCommand command = new SqlCommand("SELECT * FROM Purchasing.ShipMethod", connection))
					{
						...
						using (SqlDataReader dataReader = command.ExecuteReader(System.Data.CommandBehavior.CloseConnection))
						{
							...
							while (dataReader.Read() && rowCount < 1000 /*easy replace*/)
							{
								...
								{
									Console.WriteLine("AdventureWorks2008R2:Purchasing:ShipMethod: {0}", rowCount);
								}
								...
								try
								{
									client.Document.Create("AdventureWorks2008R2:Purchasing:ShipMethod", new Models.Purchasing_ShipMethod
									{
