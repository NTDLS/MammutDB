...
namespace Mamoth.TestHarness.Repository
{
	...
	{        
		public void Export_Sales_ShoppingCartItem()
		{
            ...
            //if(client.Schema.Exists("AdventureWorks2008R2:Sales:ShoppingCartItem"))
			//{
			//	return;
			//}
            ...
            client.Schema.CreateAll("AdventureWorks2008R2:Sales:ShoppingCartItem");
					...
					using (SqlCommand command = new SqlCommand("SELECT * FROM Sales.ShoppingCartItem", connection))
					{
						...
						using (SqlDataReader dataReader = command.ExecuteReader(System.Data.CommandBehavior.CloseConnection))
						{
							...
							while (dataReader.Read() && rowCount < 1000 /*easy replace*/)
							{
								...
								{
									Console.WriteLine("AdventureWorks2008R2:Sales:ShoppingCartItem: {0}", rowCount);
								}
								...
								try
								{
									client.Document.Create("AdventureWorks2008R2:Sales:ShoppingCartItem", new Models.Sales_ShoppingCartItem
									{
