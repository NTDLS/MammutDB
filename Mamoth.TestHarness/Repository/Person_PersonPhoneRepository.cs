...
namespace Mamoth.TestHarness.Repository
{
	...
	{        
		public void Export_Person_PersonPhone()
		{
            ...
            //if(client.Schema.Exists("AdventureWorks2008R2:Person:PersonPhone"))
			//{
			//	return;
			//}
            ...
            client.Schema.CreateAll("AdventureWorks2008R2:Person:PersonPhone");
					...
					using (SqlCommand command = new SqlCommand("SELECT * FROM Person.PersonPhone", connection))
					{
						...
						using (SqlDataReader dataReader = command.ExecuteReader(System.Data.CommandBehavior.CloseConnection))
						{
							...
							while (dataReader.Read() && rowCount < 1000 /*easy replace*/)
							{
								...
								{
									Console.WriteLine("AdventureWorks2008R2:Person:PersonPhone: {0}", rowCount);
								}
								...
								try
								{
									client.Document.Create("AdventureWorks2008R2:Person:PersonPhone", new Models.Person_PersonPhone
									{
