...
namespace Mamoth.TestHarness.Repository
{
	...
	{        
		public void Export_Production_ProductCostHistory()
		{
            ...
            //if(client.Schema.Exists("AdventureWorks2008R2:Production:ProductCostHistory"))
			//{
			//	return;
			//}
            ...
            client.Schema.CreateAll("AdventureWorks2008R2:Production:ProductCostHistory");
					...
					using (SqlCommand command = new SqlCommand("SELECT * FROM Production.ProductCostHistory", connection))
					{
						...
						using (SqlDataReader dataReader = command.ExecuteReader(System.Data.CommandBehavior.CloseConnection))
						{
							...
							while (dataReader.Read() && rowCount < 1000 /*easy replace*/)
							{
								...
								{
									Console.WriteLine("AdventureWorks2008R2:Production:ProductCostHistory: {0}", rowCount);
								}
								...
								try
								{
									client.Document.Create("AdventureWorks2008R2:Production:ProductCostHistory", new Models.Production_ProductCostHistory
									{
