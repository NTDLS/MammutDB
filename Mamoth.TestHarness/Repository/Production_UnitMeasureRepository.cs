...
namespace Mamoth.TestHarness.Repository
{
	...
	{        
		public void Export_Production_UnitMeasure()
		{
            ...
            //if(client.Schema.Exists("AdventureWorks2008R2:Production:UnitMeasure"))
			//{
			//	return;
			//}
            ...
            client.Schema.CreateAll("AdventureWorks2008R2:Production:UnitMeasure");
					...
					using (SqlCommand command = new SqlCommand("SELECT * FROM Production.UnitMeasure", connection))
					{
						...
						using (SqlDataReader dataReader = command.ExecuteReader(System.Data.CommandBehavior.CloseConnection))
						{
							...
							while (dataReader.Read() && rowCount < 1000 /*easy replace*/)
							{
								...
								{
									Console.WriteLine("AdventureWorks2008R2:Production:UnitMeasure: {0}", rowCount);
								}
								...
								try
								{
									client.Document.Create("AdventureWorks2008R2:Production:UnitMeasure", new Models.Production_UnitMeasure
									{
