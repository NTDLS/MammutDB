...
namespace Mamoth.TestHarness.Repository
{
	...
	{        
		public void Export_Sales_Store()
		{
            ...
            //if(client.Schema.Exists("AdventureWorks2008R2:Sales:Store"))
			//{
			//	return;
			//}
            ...
            client.Schema.CreateAll("AdventureWorks2008R2:Sales:Store");
					...
					using (SqlCommand command = new SqlCommand("SELECT * FROM Sales.Store", connection))
					{
						...
						using (SqlDataReader dataReader = command.ExecuteReader(System.Data.CommandBehavior.CloseConnection))
						{
							...
							while (dataReader.Read() && rowCount < 1000 /*easy replace*/)
							{
								...
								{
									Console.WriteLine("AdventureWorks2008R2:Sales:Store: {0}", rowCount);
								}
								...
								try
								{
									client.Document.Create("AdventureWorks2008R2:Sales:Store", new Models.Sales_Store
									{
