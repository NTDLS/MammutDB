...
namespace Mamoth.TestHarness.Repository
{
	...
	{        
		public void Export_Production_ProductModelIllustration()
		{
            ...
            //if(client.Schema.Exists("AdventureWorks2008R2:Production:ProductModelIllustration"))
			//{
			//	return;
			//}
            ...
            client.Schema.CreateAll("AdventureWorks2008R2:Production:ProductModelIllustration");
					...
					using (SqlCommand command = new SqlCommand("SELECT * FROM Production.ProductModelIllustration", connection))
					{
						...
						using (SqlDataReader dataReader = command.ExecuteReader(System.Data.CommandBehavior.CloseConnection))
						{
							...
							while (dataReader.Read() && rowCount < 1000 /*easy replace*/)
							{
								...
								{
									Console.WriteLine("AdventureWorks2008R2:Production:ProductModelIllustration: {0}", rowCount);
								}
								...
								try
								{
									client.Document.Create("AdventureWorks2008R2:Production:ProductModelIllustration", new Models.Production_ProductModelIllustration
									{
