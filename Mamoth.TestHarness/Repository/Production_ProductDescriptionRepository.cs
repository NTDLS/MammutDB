...
namespace Mamoth.TestHarness.Repository
{
	...
	{        
		public void Export_Production_ProductDescription()
		{
            ...
            //if(client.Schema.Exists("AdventureWorks2008R2:Production:ProductDescription"))
			//{
			//	return;
			//}
            ...
            client.Schema.CreateAll("AdventureWorks2008R2:Production:ProductDescription");
					...
					using (SqlCommand command = new SqlCommand("SELECT * FROM Production.ProductDescription", connection))
					{
						...
						using (SqlDataReader dataReader = command.ExecuteReader(System.Data.CommandBehavior.CloseConnection))
						{
							...
							while (dataReader.Read() && rowCount < 1000 /*easy replace*/)
							{
								...
								{
									Console.WriteLine("AdventureWorks2008R2:Production:ProductDescription: {0}", rowCount);
								}
								...
								try
								{
									client.Document.Create("AdventureWorks2008R2:Production:ProductDescription", new Models.Production_ProductDescription
									{
