...
namespace Mamoth.TestHarness.Repository
{
	...
	{        
		public void Export_Person_BusinessEntityContact()
		{
            ...
            //if(client.Schema.Exists("AdventureWorks2008R2:Person:BusinessEntityContact"))
			//{
			//	return;
			//}
            ...
            client.Schema.CreateAll("AdventureWorks2008R2:Person:BusinessEntityContact");
					...
					using (SqlCommand command = new SqlCommand("SELECT * FROM Person.BusinessEntityContact", connection))
					{
						...
						using (SqlDataReader dataReader = command.ExecuteReader(System.Data.CommandBehavior.CloseConnection))
						{
							...
							while (dataReader.Read() && rowCount < 1000 /*easy replace*/)
							{
								...
								{
									Console.WriteLine("AdventureWorks2008R2:Person:BusinessEntityContact: {0}", rowCount);
								}
								...
								try
								{
									client.Document.Create("AdventureWorks2008R2:Person:BusinessEntityContact", new Models.Person_BusinessEntityContact
									{
