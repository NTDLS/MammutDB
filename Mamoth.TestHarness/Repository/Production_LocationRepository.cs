...
namespace Mamoth.TestHarness.Repository
{
	...
	{        
		public void Export_Production_Location()
		{
            ...
            //if(client.Schema.Exists("AdventureWorks2008R2:Production:Location"))
			//{
			//	return;
			//}
            ...
            client.Schema.CreateAll("AdventureWorks2008R2:Production:Location");
					...
					using (SqlCommand command = new SqlCommand("SELECT * FROM Production.Location", connection))
					{
						...
						using (SqlDataReader dataReader = command.ExecuteReader(System.Data.CommandBehavior.CloseConnection))
						{
							...
							while (dataReader.Read() && rowCount < 1000 /*easy replace*/)
							{
								...
								{
									Console.WriteLine("AdventureWorks2008R2:Production:Location: {0}", rowCount);
								}
								...
								try
								{
									client.Document.Create("AdventureWorks2008R2:Production:Location", new Models.Production_Location
									{
