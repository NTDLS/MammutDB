...
namespace Mamoth.TestHarness.Repository
{
	...
	{        
		public void Export_Production_ProductCategory()
		{
            ...
            //if(client.Schema.Exists("AdventureWorks2008R2:Production:ProductCategory"))
			//{
			//	return;
			//}
            ...
            client.Schema.CreateAll("AdventureWorks2008R2:Production:ProductCategory");
					...
					using (SqlCommand command = new SqlCommand("SELECT * FROM Production.ProductCategory", connection))
					{
						...
						using (SqlDataReader dataReader = command.ExecuteReader(System.Data.CommandBehavior.CloseConnection))
						{
							...
							while (dataReader.Read() && rowCount < 1000 /*easy replace*/)
							{
								...
								{
									Console.WriteLine("AdventureWorks2008R2:Production:ProductCategory: {0}", rowCount);
								}
								...
								try
								{
									client.Document.Create("AdventureWorks2008R2:Production:ProductCategory", new Models.Production_ProductCategory
									{
