...
namespace Mamoth.TestHarness.Repository
{
	...
	{        
		public void Export_dbo_AWBuildVersion()
		{
            ...
            //if(client.Schema.Exists("AdventureWorks2008R2:dbo:AWBuildVersion"))
			//{
			//	return;
			//}
            ...
            client.Schema.CreateAll("AdventureWorks2008R2:dbo:AWBuildVersion");
					...
					using (SqlCommand command = new SqlCommand("SELECT * FROM dbo.AWBuildVersion", connection))
					{
						...
						using (SqlDataReader dataReader = command.ExecuteReader(System.Data.CommandBehavior.CloseConnection))
						{
							...
							while (dataReader.Read() && rowCount < 1000 /*easy replace*/)
							{
								...
								{
									Console.WriteLine("AdventureWorks2008R2:dbo:AWBuildVersion: {0}", rowCount);
								}
								...
								try
								{
									client.Document.Create("AdventureWorks2008R2:dbo:AWBuildVersion", new Models.dbo_AWBuildVersion
									{
